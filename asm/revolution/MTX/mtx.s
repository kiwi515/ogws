...
PSMTXIdentity:
/* 800E75F8 000E24F8  C0 02 97 A4 */	lfs f0, lbl_804C11C4@sda21(r2)
/* 800E75FC 000E24FC  C0 22 97 A0 */	lfs f1, lbl_804C11C0@sda21(r2)
...
/* 800E775C 000E265C  38 CD 82 E0 */	addi r6, r13, Unit01@sda21
...
/* 800E78C4 000E27C4  C0 02 97 A4 */	lfs f0, lbl_804C11C4@sda21(r2)
...
/* 800E7B58 000E2A58  C0 02 97 A4 */	lfs f0, lbl_804C11C4@sda21(r2)
/* 800E7B5C 000E2A5C  10 40 28 50 */	ps_neg f2, f5
/* 800E7B60 000E2A60  C0 22 97 A0 */	lfs f1, lbl_804C11C0@sda21(r2)
...
/* 800E7C00 000E2B00  C1 42 97 A8 */	lfs f10, lbl_804C11C8@sda21(r2)
...
/* 800E7C14 000E2B14  C1 22 97 AC */	lfs f9, lbl_804C11CC@sda21(r2)
...
.global PSMTXTrans
PSMTXTrans:
/* 800E7D24 000E2C24  C0 02 97 A4 */	lfs f0, lbl_804C11C4@sda21(r2)
/* 800E7D28 000E2C28  C0 82 97 A0 */	lfs f4, lbl_804C11C0@sda21(r2)
...
.global PSMTXScale
PSMTXScale:
/* 800E7DA4 000E2CA4  C0 02 97 A4 */	lfs f0, lbl_804C11C4@sda21(r2)
...
/* 800E7E30 000E2D30  C0 22 97 A0 */	lfs f1, lbl_804C11C0@sda21(r2)
...
/* 800E804C 000E2F4C  C1 42 97 A4 */	lfs f10, lbl_804C11C4@sda21(r2)
/* 800E8050 000E2F50  C1 82 97 A0 */	lfs f12, lbl_804C11C0@sda21(r2)
/* 800E8054 000E2F54  ED 21 10 28 */	fsubs f9, f1, f2
/* 800E8058 000E2F58  C1 62 97 B0 */	lfs f11, lbl_804C11D0@sda21(r2)
/* 800E805C 000E2F5C  EC 64 18 2A */	fadds f3, f4, f3
/* 800E8060 000E2F60  ED AC 00 24 */	fdivs f13, f12, f0
/* 800E8064 000E2F64  C0 02 97 B4 */	lfs f0, lbl_804C11D4@sda21(r2)
...
/* 800E8118 000E3018  C0 E2 97 A8 */	lfs f7, lbl_804C11C8@sda21(r2)
...
/* 800E812C 000E302C  C0 02 97 B8 */	lfs f0, lbl_804C11D8@sda21(r2)
...
/* 800E8148 000E3048  C0 62 97 A4 */	lfs f3, lbl_804C11C4@sda21(r2)
/* 800E814C 000E304C  C0 82 97 A0 */	lfs f4, lbl_804C11C0@sda21(r2)
/* 800E8150 000E3050  FC 20 F8 50 */	fneg f1, f31
/* 800E8154 000E3054  C0 02 97 B4 */	lfs f0, lbl_804C11D4@sda21(r2)
...
/* 800E81DC 000E30DC  C1 22 97 A4 */	lfs f9, lbl_804C11C4@sda21(r2)
/* 800E81E0 000E30E0  C1 42 97 A0 */	lfs f10, lbl_804C11C0@sda21(r2)
/* 800E81E4 000E30E4  EC 01 10 28 */	fsubs f0, f1, f2
/* 800E81E8 000E30E8  EC 64 18 2A */	fadds f3, f4, f3
/* 800E81EC 000E30EC  C0 82 97 B0 */	lfs f4, lbl_804C11D0@sda21(r2)
